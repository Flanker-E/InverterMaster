...
namespace InverterMaster
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //    if (state == false)
        //    {
        //        _serialPortConfigPanel.Visibility = Visibility.Visible;
        //    }
        //    else
        //    {
        //        _serialPortConfigPanel.Visibility = Visibility.Collapsed;
        ...
        private void Button_clearRecvDataBox_Click(object sender, RoutedEventArgs e)
        {
        ...
        //                // 将文本框中内容转换成char
        //                sendDataTextBox.Text = Utilities.ToSpecifiedText(sendDataTextBox.Text, SendMode.Character, _serialPort.Encoding);
        //                break;
        //            case "hex":
        //                // 将文本框中的内容转换成hex
        //                sendMode = SendMode.Hex;
        //                Information("提示：发送十六进制。输入十六进制数据之间用空格隔开，如：1D 2A 38。");
        //                sendDataTextBox.Text = Utilities.ToSpecifiedText(sendDataTextBox.Text, SendMode.Hex, _serialPort.Encoding);
        //                break;
        //            default:
        //                break;
        //        }
        ...
        #region EventHandler for _serialPort
        ...
        private void ReceivedDataHandler(object obj)
        {
            ...
            this.Dispatcher.Invoke(new Action(() =>
            {
                ...
                {
                    // 根据显示模式显示接收到的字节.
                    recvDataRichTextBox.AppendText(Utilities.BytesToText(recvBuffer, receiveMode, _serialPort.Encoding));
